...
Sub Datos20p4pts()
    ...
    Dim velrange(1 To 20, 1 To 12) As Range, vmax(1 To 20, 1 To 12) As Double
    Dim acelrange(1 To 20, 1 To 12) As Range, amax(1 To 20, 1 To 12) As Double
    Dim rng As Range
    Dim cell As Range
    Dim count As Integer

    ' Lanza advertencia del proceso
    MsgBox "Se generara una nueva hoja llamada valores y en ella se anexaran los valores junto con su grafica", vbExclamation, "Advertencia"
...
On Error GoTo 0
    ...
    val.Range("A26:M26").Value = Array("Fecha", "AHA", "AVA", "AAA", "BHA", "BVA", "BAA", "CHA", "CVA", "CAA", "DHA", "DVA", "DAA")
    For i = 1 To 20
    val.Range("A" & i + 26 & ":M" & i + 26).Value = Array(fecha(i), amax(i, 1), amax(i, 2), amax(i, 3), amax(i, 4), amax(i, 5), amax(i, 6), amax(i, 7), amax(i, 8), amax(i, 9), amax(i, 10), amax(i, 11), amax(i, 12))
    Next i
    ...
    seriesNames = Array("AHV", "AVV", "AAV", "BHV", "BVV", "BAV", "CHV", "CVV", "CAV", "DHV", "DVV", "DAV")
    For i = 1 To 12
    ...
    With chartObj.Chart
    ' Define la fuente de datos para la gráfica
    seriesNames = Array("AHA", "AVA", "AAA", "BHA", "BVA", "BAA", "CHA", "CVA", "CAA", "DHA", "DVA", "DAA")
