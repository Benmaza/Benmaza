...
Sub Datos10p4pts()
    ...
    MsgBox "En este momento se generara una nueva hoja llamada valores y en ella se anexaran los valores junto con su graficas", vbExclamation, "Advertencia"
...
On Error GoTo 0
    ...
    For i = 1 To 12
        ...
        .SeriesCollection(i).Values = val.Range(Cells(3, i + 1), Cells(12, i + 1))
   ...
   For i = 1 To 12
        .SeriesCollection.NewSeries
        .SeriesCollection(i).Name = seriesNames(i - 1)
        .SeriesCollection(i).Values = val.Range(Cells(22, i + 1), Cells(31, i + 1))
