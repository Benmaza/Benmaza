Sub Datos10p2pts()
    ...
    Dim velrange(1 To 10, 1 To 6) As Range, vmax(1 To 10, 1 To 6) As Double
    Dim acelrange(1 To 10, 1 To 6) As Range, amax(1 To 10, 1 To 6) As Double
    Dim rng As Range
    Dim cell As Range
...
On Error GoTo 0
    ...
    ' Limpiar y combinar celdas de A1 a G1 y agregar texto de Velocidades
    val.Range("A1:G1").ClearContents
    ...
    ' Limpiar y combinar celdas de A20 a G20 y agregar texto de Aceleraciones
    val.Range("A20:G20").ClearContents
    With val.Range("A20:G20")
        .Merge
        .HorizontalAlignment = xlCenter
        .VerticalAlignment = xlCenter
        .Value = "Aceleraciones"
    ...
    val.Range("A21:G21").Value = Array("Fecha", "AHA", "AVA", "AAA", "BHA", "BVA", "BAA")
    For i = 1 To 10
    ...
    With chartObj.Chart
        ...
        For i = 1 To 6
            ...
            .SeriesCollection(i).Values = val.Range(val.Cells(3, i + 1), val.Cells(12, i + 1))
    ...
    With chartObj.Chart
       ...
       For i = 1 To 6
            .SeriesCollection.NewSeries
            .SeriesCollection(i).Name = seriesNames(i - 1)
            .SeriesCollection(i).Values = val.Range(val.Cells(22, i + 1), val.Cells(31, i + 1))
